    ...
    <section className="blog_details_section section_space bg-light">
      <div className="container">
        <div className="details_item_image">
          <Image src={blog1} alt="Devyaar - Blog" />
        </div>
        ...
        <p>
          Delve into the inner workings of IT solutions with Devyaar's esteemed
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="row mb-4">
                <div className="col-md-6 col-sm-6">
                  <div className="details_item_image m-0">
                    <Image src={blog2} alt="Devyaar - Blog" />
                  </div>
                </div>
                <div className="col-md-6 col-sm-6">
                  <div className="details_item_image m-0">
                    <Image src={blog3} alt="Devyaar - Blog" />
                  </div>
                </div>
              </div>
              <p>
                Gain exclusive insights into the world of IT solutions with
                Devyaar's distinguished thought leaders. With years of
              ...
              <p>
                ...
                with Devyaar's esteemed thought leaders. Delve deep into the
              ...
              <p>
                ...
                solutions, guided by the wisdom and expertise of Devyaar's
              ...
              <div className="row align-items-center mb-5">
                <div className="col-md-6">
                  <div className="details_item_image m-0">
                    <Image src={blog4} alt="Devyaar - Blog" />
                  </div>
                </div>
                <div className="col-md-6">
              ...
              <div className="post_author_box">
                <div className="author_image">
                  <Image src={author} alt="Devyaar - Blog Author" />
                </div>
              ...
              <div className="other_posts_nav">
                <Link onClick={ClickHandler} href={"/blog"}>
                  ...
                  <span>
                    <strong>Exploring IT Solutions with Devyaar</strong>
                  ...
                  <li>
                    <div className="comment_item">
                      <div className="comment_author_thumbnail">
                        <Image
                          src={author2}
                          alt="Devyaar - Comment Author Avatar"
                        />
                      </div>
                      <div className="comment_author_content">
                        ...
                        <p className="mb-0">
                          "Working with Devyaar has been a game-changer. Their
                      ...
                      <li>
                        <div className="comment_item">
                          ...
                          <div className="comment_author_content">
                            ...
                            <p className="mb-0">
                              "Our experience with Devyaar has been exceptional.
                      ...
                      <li>
                        <div className="comment_item">
                          ...
                          <div className="comment_author_content">
                            ...
                            <p className="mb-0">
                              "Working with Devyaar has been a game-changer.
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        type="email"
                        name="email"
                        placeholder="Devyaar@example.com"
                        required
                      />
                    </div>
                  </div>
