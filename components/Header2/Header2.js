...
import logo from "/public/images/site_logo/logo.svg";
import logo2 from "/public/images/site_logo/logo.svg";
            ...
            <div className="col-xl-3 col-lg-2 col-5">
              <div className="site_logo ">
                <Link onClick={ClickHandler} className="site_link " href="/">
                  ...
                  />
                  <span className="logo_text">DEVYAAR</span>
                </Link>
              </div>
            </div>
                            ...
                            <div className="col-lg-3">
                              <div className="site_author bg-primary">
                                ...
                                <p className="mb-0 text-white">
                                  As a CEO at Devyaar I have been voice crying
                                  in the wilderness, trying to make requirements
                                  clear, use every minute to deliver the result,
                                  and not reinvent the wheel. Here at Devyaar, I
