        ...
        <header className="site_header site_header_1">
            <div className="header_top text-center">
                <div className="container">
                    <p className="m-0">DH Solutions prioritizes privacy, ensuring secure and confidential handling of all personal data. <Link onClick={ClickHandler} href="/pricing"><u>Learn more</u> <i className="fa-solid fa-angle-right"></i></Link></p>
                </div>
            </div>
                                                            ...
                                                            <div className="site_author bg-primary">
                                                                <div className="author_box">
                                                                    ...
                                                                    <div className="author_box_content">
                                                                        <h3 className="author_name text-white">Mudassir Jaleel</h3>
                                                                        <span className="author_designation text-white">Founder at DH Solutions</span>
                                                                    </div>
                                                                ...
                                                                As CEO of DH Solutions, I’ve focused on clarity, efficiency, and innovation, positioning us to become a leading international venture in the years ahead.
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row justify-content-lg-between">
                                                        <div className="col-lg-8">
                                                            <div className="row">
                                                                ...
                                                                <div className="col-lg-4">
                                                                    <div className="megamenu_widget">
                                                                        <h3 className="megamenu_info_title">Top Notch Services</h3>
                                                                        <ul className="icon_list unordered_list_block">
                                                                            <li>
