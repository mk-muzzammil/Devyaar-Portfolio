        ...
        <div className="row">
          <div className="col-lg-7">
            ...
            >
              ...
              <h1>Revolutionize Industries with AI-Powered Technology</h1>
              <p>
                Empowering businesses with advanced AI solutions to enhance
                efficiency, drive innovation, and create smarter systems for a
                competitive edge.
              </p>
                ...
                <li>
                  <div className="review_short_info">
                    <div className="d-flex">
                      <Image src={icon} alt="Devyaar - Trustpilot Review" />
                      <span>4.8</span>
                    </div>
          ...
          <div className="col-lg-5">
            <ul className="it_solution_hero_images unordered_list">
              <li>
                <Image src={heroImg} alt="Devyaar - IT Solution - Hero" />
              </li>
              <li>
                <div className="worldwide_clients">
                  ...
                  <ul className="avatar_group unordered_list">
                    <li>
                      <Image src={avatar1} alt="Devyaar - Avatar" />
                    </li>
                    <li>
                      <Image src={avatar2} alt="Devyaar - Avatar" />
                    </li>
                    <li>
                      <Image src={avatar3} alt="Devyaar - Avatar" />
                    </li>
                    <li>5k+</li>
                  </ul>
                </div>
