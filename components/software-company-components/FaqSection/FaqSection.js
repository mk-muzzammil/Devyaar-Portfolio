  ...
  return (
    <section className="faq_section section_decoration">
          ...
          >
            <AccordionItem className="accordion-item">
              ...
              <AccordionBody accordionId="1" className="acc_body">
                ...
                <p>
                  A custom software development company is a vendor that builds
                  unique software from scratch. Also, such vendors provide a
                  range of other useful services like software upgrades,Here is
                  an extended list of services:
                </p>
                <div className="row">
      ...
      <div className="decoration_item shape_image_2">
        <Image src={shape2} alt="Devyaar Shape Angle" />
      </div>
    </section>
  );
};
